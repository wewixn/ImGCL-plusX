...
from util.PS import sim_sample, over_sample, cluster_with_outlier
    ...
    def train(self):
        ...
        with tqdm(total=self.config['num_epochs'], desc='(T)') as pbar:
            for epoch in range(1, self.config['num_epochs']+1):
                ...
                z, z1, z2 = self.model(data_train.x, data_train.edge_index, data_train.edge_attr)
